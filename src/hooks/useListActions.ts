    ...
    const handleSortMenu = useCallback(
        (event: React.MouseEvent) => {
            ...
            if (effectiveGroupPropertyKey !== null) {
                ...
                // split. Toggling back to the default grouping clears the override instead of storing
                // a copy of it, through the same path as the group order entries.
