...
export const STRINGS_RU = {
    ...
    paneHeader: {
        ...
        splitListValues: 'Разделять несколько значений по группам',
    ...
    settings: {
        ...
        pageDescriptions: {
            ...
            navigationPane: 'Компоновка, внешний вид, количество файлов, поведение сворачивания и цвета радуги.',
        ...
        items: {
            ...
            propertySortKey: {
                ...
                desc: 'Свойства frontmatter, разделённые запятыми. Каждое свойство отображается как вариант сортировки в настройке «Порядок сортировки по умолчанию» и в меню сортировки на панели списка. Эти свойства не изменяются.',
            ...
            propertySortInstructions: {
                ...
                items: [
                    ...
                    '**Несколько значений:** Если свойство содержит список, Notebook Navigator использует весь список. Например, если свойство «Темы» содержит «Книги» и «История», заметка сортируется или группируется по полному значению «Книги, История». Включите **Разделять несколько значений по группам** в меню сортировки и группировки, чтобы заметка попала и в «Книги», и в «Историю» по отдельности.',
                    '**Отсутствующие значения:** При группировке заметки без этого свойства отображаются в конце под **Нет**.',
                    '**Представления тегов и свойств:** Если выбрана группировка **Папка**, вместо неё отображаются заголовки дат.'
                ]
            },
            propertyGroupKey: {
            ...
            groupNotes: {
                ...
                desc: '**Заголовки** помечают отсортированный список, не меняя его порядок: «Произвольная» отображает заголовки, заданные в frontmatter, а «По дате» вставляет заголовки дат. **Группы** переупорядочивают список: группы папок и свойств упорядочиваются отдельно, а заметки внутри каждой группы следуют порядку сортировки.',
                families: {
                    headers: 'Заголовки',
                    groups: 'Группы'
                },
            ...
            inheritPropertyValueHeaderAppearance: {
                name: 'Оформлять заголовки групп',
                desc: 'Заголовки групп для одного значения свойства или тега берут значок и цвет этого значения из дерева навигации.'
            },
            stickyGroupHeaders: {
            ...
            propertyHierarchyMaxDepth: {
                name: 'Максимальная глубина иерархии',
                desc: 'Сколько уровней вложенности имеет иерархическое свойство ниже своих значений верхнего уровня. Ограничение безопасности; большинство хранилищ никогда его не достигают.',
                resetTooltip: 'Сбросить максимальную глубину иерархии по умолчанию'
            },
            hiddenTags: {
            ...
            enablePropertyNoteLinks: {
                name: 'Связывать значения свойств с заметками',
            ...
            autoRevealPropertyNote: {
                name: 'Автопоказ заметки свойства в дереве',
