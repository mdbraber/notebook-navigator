    ...
    settings: {
        ...
        items: {
            ...
            inheritPropertyValueHeaderAppearance: {
                name: 'Окрашивать заголовки групп по значению',
                desc: 'При группировке по каждому значению свойства заголовки групп берут значок и цвет этого значения из дерева навигации.'
            },
            stickyGroupHeaders: {
