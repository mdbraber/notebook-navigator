...
export const STRINGS_TH = {
    ...
    paneHeader: {
        ...
        splitListValues: 'แยกหลายค่าตามกลุ่ม',
        ...
        items: {
            ...
            propertySortInstructions: {
                ...
                items: [
                    ...
                    '**หลายค่า:** หากคุณสมบัติมีรายการ Notebook Navigator จะใช้รายการทั้งหมด ตัวอย่างเช่น หากหัวข้อมีหนังสือและประวัติศาสตร์ ระบบจะจัดเรียงหรือจัดกลุ่มโน้ตโดยใช้ “หนังสือ, ประวัติศาสตร์” เปิด **แยกหลายค่าตามกลุ่ม** ในเมนูจัดเรียงและจัดกลุ่มเพื่อจัดกลุ่มโน้ตไว้ในหนังสือและประวัติศาสตร์แยกกัน',
            ...
            inheritPropertyValueHeaderAppearance: {
                name: 'ตกแต่งหัวข้อกลุ่ม',
                desc: 'หัวข้อกลุ่มของค่าคุณสมบัติเดียวหรือของแท็ก จะใช้ไอคอนและสีของค่านั้นจากแผนผังการนำทาง'
            },
            stickyGroupHeaders: {
            ...
            enablePropertyNoteLinks: {
                name: 'เชื่อมโยงค่าคุณสมบัติกับโน้ต',
            ...
            autoRevealPropertyNote: {
                name: 'แสดงโน้ตคุณสมบัติในแผนผังอัตโนมัติ',
