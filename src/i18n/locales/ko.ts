        ...
        items: {
            ...
            propertySortInstructions: {
                ...
                items: [
                    ...
                    '**여러 값:** 속성에 목록이 포함된 경우 Notebook Navigator는 전체 목록을 사용합니다. 예를 들어 주제에 책과 역사가 포함되어 있으면 “책, 역사”를 사용하여 노트를 정렬하거나 그룹화합니다. 정렬 및 그룹 메뉴에서 **여러 값을 그룹별로 분리**를 켜면 노트가 책과 역사에 각각 그룹화됩니다.',
            ...
            inheritPropertyValueHeaderAppearance: {
                name: '그룹 헤더 장식',
                desc: '단일 속성 값 또는 태그의 그룹 헤더가 내비게이션 트리에서 해당 값의 아이콘과 색상을 가져옵니다.'
            },
            stickyGroupHeaders: {
                name: '그룹 헤더 고정',
